<div class="container">
    ...
    <form class="form-inline" role="form" method="post" action="<?= URL ?>lennontiedot/confirmWishes">
        <div class="col-lg-11">
            <?php
    ...
    <legend></legend>
    <div class="col-lg-8">
        <a href="<?= URL ?>lennontiedot/cancelOrder"<button class="btn btn-success">Peru tilaus</button></a>
    </div>
